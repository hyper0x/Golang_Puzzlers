...
2019年3月，经过再三考虑，我决定在[知识星球App](https://www.zsxq.com/)上创建一个名为`GoHackers`的付费星球，旨在与gopher们进一步围绕Go语言程序设计进行交流，互通有无、互惠共进。

我已经邀请了几位国内知名的Go语言技术布道者成为该星球的合伙人。我们每周（甚至每天）都会在这个星球里发布一些有价值的信息或文章。现诚邀所有喜爱Go语言的技术人入驻。大家可以下载知识星球App并搜索“GoHackers”，也可以直接扫描下图中的二维码入驻。

![GoHackers Planet](gohackers_planet.jpeg)
